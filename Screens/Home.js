...
import { StyleSheet, 
  ...
  import { faHeartCirclePlus,faRightFromBracket,faImages } from '@fortawesome/free-solid-svg-icons';
...
{/* <Image source={require('../assets/pic.jpg')}
  ...
  return (
    <><View style={style.counter}>
      <View style={style.container}>
        ...
        <TouchableOpacity style={style.out} onPress={() => navigation.navigate('Gallery')}>
          <FontAwesomeIcon icon={faImages} size={28} color='white'/>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Signin')} >
          <FontAwesomeIcon icon={faRightFromBracket} size={28} color='white'/>
        </TouchableOpacity>
      </View>
  ...
  <SafeArea>
    ...
    <Slideshow 
      dataSource={[
        { url: require('../assets/maidabo.jpg') },
        { url: require('../assets/maidabo1.jpg') },
        { url: require('../assets/maidabo2.jpg') },
    ]}/>
