...
{/* <Image source={require('../assets/pic.jpg')}
  ...
  return (
    <><View style={style.counter}>
      <View style={style.container}>
        ...
        <TouchableOpacity style={style.out} onPress={() => navigation.navigate('Signup')}>
  ...
  <SafeArea>
    ...
    <View style={ahmad.nav}>
        <Text style={ahmad.learn}>About Maidabo Foundation</Text>
        
          <TouchableOpacity onPress={() => navigation.navigate('About')}>
          <Text style={ahmad.more}>Click here</Text>
          </TouchableOpacity>
      </View>
    <TouchableOpacity onPress={() => navigation.navigate('Gallery')}>
    <View style={style.box}>
      <Text style={style.bar}> Click here to see galary </Text>
    ...
    <View style={style.box}>
      <Text style={style.bar}> Help the helpless, Donate Now </Text>
      <FontAwesomeIcon icon={faArrowRight} size={30}
      style={style.image}
      />
      </View></TouchableOpacity>
